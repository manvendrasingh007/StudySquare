          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input title="TXN_AMOUNT" class="form-control" tabindex="10"
                ...
                value="<?php echo isset($_POST['price']) ? $_POST['price'] : ''; ?>" readonly>
            </div>
          </div>
          <div class="text-center">
            <input value="Proceed" type="submit" class="btn btn-primary mr-2" onclick="">
            <a href="./courses.php" class="btn btn-secondary">Cancel</a>
          </div>
        </form>
        <small class="form-text text-muted">Note: Complete Payment by Clicking Proceed Button</small>
      </div>
    </div>
  </div>
