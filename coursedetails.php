              ...
              <div class="card-body">
                ...
                <form action="checkout.php" method="post">
                  <p class="card-text d-inline">
                    Price: <span class="font-weight-bolder">&#8377; '.$row['course_price'].'<span>
                  </p>
                  <!-- Pass the course price to checkout.php -->
                  <input type="hidden" name="price" value="'. $row["course_price"] .'"> 
                  <button type="submit" class="btn btn-primary text-white font-weight-bolder float-right" name="buy">Get this</button>
                </form>
              </div>
            </div>
          </div>';
